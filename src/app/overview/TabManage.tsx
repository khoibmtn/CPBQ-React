...
export default function TabManage() {
    ...
    /* ── Column width config ── */
    /* Use minWidth (not width) so the browser cannot compress columns below threshold */
    const COL_WIDTHS: Record<string, { minWidth?: number; width?: number; maxWidth?: number }> = {
        // IDs & codes
        stt:              { minWidth: 50 },
        ma_bn:            { minWidth: 105 },
        gioi_tinh:        { minWidth: 35 },
        ma_dkbd:          { minWidth: 65 },
        ma_benh:          { minWidth: 60 },
        ma_benhkhac:      { minWidth: 80 },
        ma_lydo_vvien:    { minWidth: 40 },
        ma_noi_chuyen:    { minWidth: 60 },
        so_ngay_dtri:     { minWidth: 55 },
        ket_qua_dtri:     { minWidth: 50 },
        tinh_trang_rv:    { minWidth: 55 },
        ma_khoa:          { minWidth: 60 },
        nam_qt:           { minWidth: 55 },
        thang_qt:         { minWidth: 55 },
        ma_khuvuc:        { minWidth: 55 },
        ma_loaikcb:       { minWidth: 55 },
        ma_cskcb:         { minWidth: 65 },
        noi_ttoan:        { minWidth: 55 },
        giam_dinh:        { minWidth: 55 },
        is_normalized:    { minWidth: 55 },

        // Names & text
        ho_ten:           { minWidth: 140 },
        dia_chi:          { minWidth: 200 },
        ma_the:           { minWidth: 130 },
        ten_cskcb:        { minWidth: 130 },
        khoa:             { minWidth: 90 },
        ml2:              { minWidth: 85 },
        ml4:              { minWidth: 90 },
        ma_benh_chinh:    { minWidth: 60 },

        // Dates
        ngay_sinh:        { minWidth: 90 },
        gt_the_tu:        { minWidth: 95 },
        gt_the_den:       { minWidth: 95 },
        ngay_vao:         { minWidth: 155 },
        ngay_ra:          { minWidth: 155 },
        normalized_at:    { minWidth: 130 },

        // Money fields
        t_tongchi:        { minWidth: 100 },
        t_xn:             { minWidth: 85 },
        t_cdha:           { minWidth: 70 },
        t_thuoc:          { minWidth: 85 },
        t_mau:            { minWidth: 55 },
        t_pttt:           { minWidth: 80 },
        t_vtyt:           { minWidth: 70 },
        t_dvkt_tyle:      { minWidth: 65 },
        t_thuoc_tyle:     { minWidth: 70 },
        t_vtyt_tyle:      { minWidth: 65 },
        t_kham:           { minWidth: 65 },
        t_giuong:         { minWidth: 80 },
        t_vchuyen:        { minWidth: 70 },
        t_bntt:           { minWidth: 100 },
        t_bhtt:           { minWidth: 100 },
        t_ngoaids:        { minWidth: 75 },
        t_xuattoan:       { minWidth: 70 },
        t_nguonkhac:      { minWidth: 70 },
        t_datuyen:        { minWidth: 70 },
        t_vuottran:       { minWidth: 70 },
    };
